...
class DataTransformation():
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logger.info("Features standard scaling and enconding completed !")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logger.info("Train features and target extracted!")
            ...
            logger.info("Prepocessing object applied on train input features!")

            input_feature_test_arr = prepocessing_obj.transform(input_feature_test_df)
            logger.info("Prepocessing object applied on test input features!")
            ...
            logger.info("Preprocessing object saved!")
